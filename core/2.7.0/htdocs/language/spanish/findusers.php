...
define('_MA_USER_ADD_SELECTED', 'Agregar usuarios seleccionados');
...
define('_MA_USER_REGDATE', 'Fecha de registro');
define('_MA_USER_EMAIL', 'Correo electrónico');
define('_MA_USER_PREVIOUS', 'Anterior');
define('_MA_USER_NEXT', 'Siguiente');
define('_MA_USER_USERSFOUND', '%s usuario(s) encontrado(s)');
...
define('_MA_USER_AIM', 'Identificador AIM');
define('_MA_USER_YIM', 'Enlace YIM');
define('_MA_USER_MSNM', 'Enlace MSNM');
define('_MA_USER_LOCATION', 'Ubicación contiene');
define('_MA_USER_OCCUPATION', 'Ocupación contiene');
define('_MA_USER_INTEREST', 'Interés contiene');
...
define('_MA_USER_POSTS', 'Número de publicaciones');
...
define('_MA_USER_MAILOK', 'Solo usuarios que aceptan correo electrónico');
define('_MA_USER_MAILNG', 'Solo usuarios que no aceptan correo electrónico');
define('_MA_USER_BOTH', 'Todos');
define('_MA_USER_RANGE_LAST_LOGIN', 'Conectado en los últimos <span style=\'color:#ff0000;\'>X</span> días');
define('_MA_USER_RANGE_USER_REGDATE', 'Registrado en los últimos <span style=\'color:#ff0000;\'>X</span> días');
define('_MA_USER_RANGE_POSTS', 'Publicaciones');
...
define('_MA_USER_NOUSERSELECTED', 'No se seleccionó ningún usuario');
define('_MA_USER_USERADDED', 'Los usuarios han sido añadidos');
define('_MA_USER_SENDMAIL', 'Enviar correo electrónico');
define('_MA_USER_FACEBOOK', 'Enlace de Facebook');
define('_MA_USER_SKYPE', 'Enlace de Skype');

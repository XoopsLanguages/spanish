...
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD', 'Derecho de acceso de usuario añadido para el ID del Grupo: %s');
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD_ERROR', 'ERROR: No se pudo añadir el derecho de acceso de usuario para el ID del Grupo: %s');
...
// 2.7.0
define('_AM_SYSTEM_MODULES_FK_DISABLE', 'No se pudieron deshabilitar las comprobaciones de claves externas');
define('_AM_SYSTEM_MODULES_FK_ENABLE', 'No se pudieron habilitar las comprobaciones de claves externas');
define('_AM_SYSTEM_MODULES_DROP_FAIL', 'No se pudo eliminar la tabla: %s');
define('_AM_SYSTEM_MODULES_DROP_OK', 'Tabla descartada: %s');
//2.7.1

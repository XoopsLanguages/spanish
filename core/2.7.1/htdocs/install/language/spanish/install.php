...
define('_WEBSITE_SLOGAN', '¡Solo úsalo!');
define('_WEBSITE_META_KEYWORDS', 'xoops, marco de aplicación web, cms, sistema de gestión de contenidos');
define('_WEBSITE_FOOTER', "Desarrollado por XOOPS © 2001-{X_YEAR} <a href='https://xoops.org' rel='external' title='The XOOPS Project'>El proyecto XOOPS</a>");
define('_WEBSITE_COPYRIGHT', 'Copyright © 2001-{X_YEAR}');
define('_WEBSITE_DESCRIPTION', 'XOOPS es un script de portal dinámico de código abierto basado en objetos orientados y escrito en PHP.');
define('_WEBSITE_CENSOR_REPLACE', '¡Uy!');
// 2.7.1
